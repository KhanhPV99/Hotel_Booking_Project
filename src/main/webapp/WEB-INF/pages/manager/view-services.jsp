                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h3 class="card-title">View all services</h3>
                                </div>
                                <!-- /.card-header -->
                                <div class="card-body">
                                    <table id="example1" class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                            <c:if test="${services != null && fn:length(services) > 0}">
                                                <c:forEach items="${services}" var="service">
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <img src="<c:url value="../resources-management/images/${service.images[0].name}"/>"  WIDTH="100" HEIGHT="100" style="border:1px solid black""/>
                                                            <%-- 
...
<!--                                                            <button class="btn btn-info"
                                                                    onclick="location.href = '<c:url value="/manager/service-edit/${service.id}" />'">Edit</button>-->
                                                            <a class="btn btn-info btn-sm" href="<c:url value="/manager/service-edit/${service.id}" />">
                                                                <i class="fas fa-pencil-alt">
                                                                </i>
                                                                Edit
                                                            </a>
<!--                                                            <button class="btn btn-danger"
                                                                    onclick="location.href = '<c:url value="/manager/service-delete/${service.id}" />'">Delete</button>-->
                                                            <a class="btn btn-danger btn-sm" href="<c:url value="/manager/service-delete/${service.id}" />">
