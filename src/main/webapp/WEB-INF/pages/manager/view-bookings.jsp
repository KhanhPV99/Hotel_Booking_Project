                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <form class="form-horizontal" action="${pageContext.request.contextPath}/manager/search-booking" method="POST">
                                            ...
                                            <c:if test="${bookings != null && fn:length(bookings) > 0}">
                                                <c:forEach items="${bookings}" var="booking">
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a class="btn btn-info btn-sm" href="<c:url value="/manager/booking-view/${booking.id}" />">
