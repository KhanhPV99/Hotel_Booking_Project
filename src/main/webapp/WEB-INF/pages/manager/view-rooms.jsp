...
<!--                                                            <button class="btn btn-info"
                                                                    onclick="location.href = '<c:url value="/manager/room-edit/${room.id}" />'">Edit</button>-->
                                                            <a class="btn btn-info btn-sm" href="<c:url value="/manager/room-edit/${room.id}" />">
                                                                <i class="fas fa-pencil-alt">
                                                                </i>
                                                                Edit
                                                            </a>
<!--                                                            <button class="btn btn-danger"
                                                                    onclick="location.href = '<c:url value="/manager/room-delete/${room.id}" />'">Delete</button>-->
                                                            <a class="btn btn-danger btn-sm" href="<c:url value="/manager/room-delete/${room.id}" />">
